...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // filrouge_default_index
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'filrouge_default_index');
            }

            return array (  '_controller' => 'FilRougeBundle\\Controller\\DefaultController::indexAction',  '_route' => 'filrouge_default_index',);
        }
        ...
        if (0 === strpos($pathinfo, '/serie')) {
            ...
            if (rtrim($pathinfo, '/') === '/serie') {
                ...
                return array (  '_controller' => 'FilRougeBundle\\Controller\\SerieController::indexAction',  '_route' => 'serie_index',);
            }
            not_serie_index:
            ...
            if ($pathinfo === '/serie/new') {
                ...
                return array (  '_controller' => 'FilRougeBundle\\Controller\\SerieController::newAction',  '_route' => 'serie_new',);
            }
            not_serie_new:
            ...
            if (preg_match('#^/serie/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'serie_show')), array (  '_controller' => 'FilRougeBundle\\Controller\\SerieController::showAction',));
            }
            not_serie_show:
            ...
            if (preg_match('#^/serie/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'serie_edit')), array (  '_controller' => 'FilRougeBundle\\Controller\\SerieController::editAction',));
            }
            not_serie_edit:
            ...
            if (preg_match('#^/serie/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'serie_delete')), array (  '_controller' => 'FilRougeBundle\\Controller\\SerieController::deleteAction',));
            }
            not_serie_delete:
